#ifndef _BMP_H
#define _BMP_H 0x010103

#include <stdio.h>
#include <malloc.h>#ifndef _BMP_H
#define _BMP_H 0x010103
...
BITMAP* BitmapHeaderInit(const char* filename, int readable, _ulong width, _ulong height) {
	...
	bitmap -> readable = readable;#ifndef _BMP_H
#define _BMP_H 0x010103
...
inline double BitmapConvertCenterLocalCoord(double midpoint, double ratio, double coord) {
	return midpoint + ratio * (0.5 + coord);
}
inline double BitmapConvertEdgeLocalCoord(double edge, double ratio, double coord) {
	return edge + ratio * coord;
}
...
inline _ulong BitmapLongReversedRainbowColor(_ulong x) {
	switch(x / 17) {
		...
		case 3: return 0x00ff00 | (68-x) * 15 << 16;
		case 4: return 0x00ff00 | (x-68) * 15;
		case 5: return 0x0000ff | (102-x)* 15 << 8;#ifndef _BMP_H
#define _BMP_H 0x010103
...
inline double BitmapConvertCenterLocalCoord(double midpoint, double ratio, double centerCoord) {
	return midpoint + ratio * (0.5 + centerCoord);
}
inline double BitmapConvertEdgeLocalCoord(double edge, double ratio, double edgeCoord) {
	return edge + ratio * edgeCoord;
}
...
inline _ulong BitmapConvertCenterLocalCoord(double midpoint, double ratio, double centerCoord) {
	return midpoint + ratio * (0.5 + centerCoord);
}
inline _ulong BitmapConvertEdgeLocalCoord(double edge, double ratio, double edgeCoord) {
	return edge + ratio * edgeCoord;
}
